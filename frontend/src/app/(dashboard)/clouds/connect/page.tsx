...
export default function ConnectCloudPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left panel — branding */}
      <div className="w-80 min-w-80 bg-[#0f172a] text-white flex flex-col justify-between p-8">
        <div>
          <Link href="/clouds" className="flex items-center gap-2 mb-10 text-gray-400 hover:text-white text-sm transition-colors">
        ...
        <p className="text-xs text-gray-600">Your credentials are encrypted and stored securely.</p>
      </div>

      {/* Right panel — content */}
      <div className="flex-1 bg-white flex items-start justify-center p-10 overflow-y-auto">
        <div className="w-full max-w-lg">
          {/* Step 1: Choose Provider */}
          {step === 1 && (
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-1">Choose your cloud provider</h3>
              <p className="text-sm text-gray-500 mb-8">Select the cloud platform you want to connect.</p>
              <div className="space-y-3">
                <button
                  onClick={() => selectProvider("gcp")}
                  className="w-full flex items-center gap-4 p-5 border-2 border-gray-200 rounded-xl hover:border-primary hover:bg-primary/5 transition-all text-left cursor-pointer"
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">Connect your GCP project for security scanning</div>
                  </div>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" strokeWidth="2" className="ml-auto">
                    <path d="M9 18l6-6-6-6" />
                  </svg>
                </button>

                <div className="w-full flex items-center gap-4 p-5 border-2 border-gray-100 rounded-xl bg-gray-50 opacity-60 cursor-not-allowed">
                  ...
                  <div>
                    <div className="font-semibold text-gray-500">Amazon Web Services</div>
                    <div className="text-sm text-gray-400">Connect your AWS account</div>
                  </div>
                  <span className="ml-auto px-2.5 py-1 bg-gray-200 text-gray-500 text-xs font-semibold rounded-full">Coming Soon</span>
                </div>
                ...
                <div className="w-full flex items-center gap-4 p-5 border-2 border-gray-100 rounded-xl bg-gray-50 opacity-60 cursor-not-allowed">
                  ...
                  <div>
                    <div className="font-semibold text-gray-500">Microsoft Azure</div>
                    <div className="text-sm text-gray-400">Connect your Azure subscription</div>
                  </div>
                  <span className="ml-auto px-2.5 py-1 bg-gray-200 text-gray-500 text-xs font-semibold rounded-full">Coming Soon</span>
                </div>
              </div>
          ...
          {step === 2 && (
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-1">Authentication</h3>
              <p className="text-sm text-gray-500 mb-8">Provide your GCP credentials for NeuralWarden to scan your infrastructure.</p>
              ...
              <div className="space-y-5">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">Service Account Key (JSON)</label>
                  <div
                    onDrop={handleFileDrop}
                    onDragOver={(e) => e.preventDefault()}
                    className="border-2 border-dashed border-gray-200 rounded-lg p-6 text-center hover:border-primary/40 transition-colors"
                  >
                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" strokeWidth="1.5" className="mx-auto mb-2">
                      <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M17 8l-5-5-5 5M12 3v12" />
                    </svg>
                    <p className="text-sm text-gray-500 mb-2">Drag and drop your JSON key file here</p>
                    <label className="inline-flex items-center gap-1 px-3 py-1.5 bg-gray-100 text-gray-600 text-sm font-medium rounded-lg cursor-pointer hover:bg-gray-200 transition-colors">
                      Browse Files
          ...
          {step === 3 && (
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-1">Configure</h3>
              <p className="text-sm text-gray-500 mb-8">Name your cloud and select which services to scan.</p>
              ...
              <div className="space-y-5">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-3">Services to scan</label>
          ...
          {step === 4 && (
            <div>
              ...
              <p className="text-sm text-gray-500 mb-8">Review your configuration and connect your cloud.</p>

              <div className="bg-gray-50 rounded-xl p-5 space-y-3 mb-6">
                <div className="flex justify-between">
                  <span className="text-sm text-gray-500">Provider</span>
                  <span className="text-sm font-medium text-gray-900 uppercase">{data.provider}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-gray-500">Project ID</span>
                  <code className="text-sm font-mono text-gray-900">{data.projectId}</code>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium text-gray-900 capitalize">{data.purpose}</span>
                </div>
          ...
          {step === 5 && createdCloud && (
            <div className="text-center py-10">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Cloud Connected!</h3>
              <p className="text-gray-500 mb-2">
                <span className="font-medium text-gray-900">{createdCloud.name}</span> has been successfully connected.
              </p>
