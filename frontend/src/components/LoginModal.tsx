...
export default function LoginModal({ open, onClose }: LoginModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      {/* Backdrop */}
      <div className="absolute inset-0 bg-[#040a07]/80 backdrop-blur-sm" onClick={onClose} />

      {/* Modal */}
      <div className="relative bg-[#081510] border border-[#122a1e] rounded-2xl p-8 w-full max-w-sm shadow-2xl shadow-black/50">
        {/* Close button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-[#3a5548] hover:text-white transition-colors cursor-pointer"
        >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[11px] text-[#3a5548] uppercase tracking-[0.2em] mb-2">Initializing Identity Handshake</p>
          <h2 className="text-lg font-bold text-white">SYSTEM ACCESS</h2>
          <p className="text-sm text-[#3a5548] mt-1">Authorization Required</p>
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl bg-[#0a1a12] border border-[#122a1e] text-white font-medium hover:bg-[#0e2018] hover:border-[#00e68a]/30 transition-all cursor-pointer"
          >
