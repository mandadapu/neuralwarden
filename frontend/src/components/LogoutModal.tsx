...
export default function LogoutModal({ open, onClose }: LogoutModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-[#081510] border border-[#122a1e] rounded-2xl p-8 w-full max-w-sm shadow-2xl">
        {/* Icon */}
        ...
        <p className="text-center text-sm text-[#5a7068] mb-7">
        ...
        <div className="flex gap-3">
          <button
            onClick={onClose}
            className="flex-1 px-4 py-2.5 rounded-xl border border-[#122a1e] text-[#c0d0c8] font-medium hover:bg-[#0c1e18] transition-colors cursor-pointer"
          >
            Cancel
          </button>
