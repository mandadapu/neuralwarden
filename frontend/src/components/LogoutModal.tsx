...
export default function LogoutModal({ open, onClose }: LogoutModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-[#1c2128] border border-[#30363d] rounded-2xl p-8 w-full max-w-sm shadow-2xl">
        {/* Icon */}
        ...
        <p className="text-center text-sm text-[#8b949e] mb-7">
        ...
        <div className="flex gap-3">
          <button
            onClick={onClose}
            className="flex-1 px-4 py-2.5 rounded-xl border border-[#30363d] text-[#e6edf3] font-medium hover:bg-[#262c34] transition-colors cursor-pointer"
          >
            Cancel
          </button>
