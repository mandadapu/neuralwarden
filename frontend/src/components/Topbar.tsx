  ...
  return (
    <div className="flex items-center justify-between px-7 py-4 bg-white border-b border-gray-200">
      ...
      <div className="flex items-center gap-4.5">
        ...
        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-primary to-purple-400 flex items-center justify-center text-white font-semibold text-[13px] cursor-pointer">
          SA
        </div>
      </div>
    </div>
